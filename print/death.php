...
if (isset($_GET['id'])) {
    ...
    if ($id != "") {
        ...
        try {
            ...
            $text = "http://shambhaviagro.in/grampanchyatpalasdeo/print/death.php?id=$id";
            $path = '../qrImage/';
            ...
            <div class="container-fluid" style="height: 1500px;border: 2px solid black">
                ...
                <div class="tblock row" style="margin-top: 25px;">
                    <div class="tdata1 col-7 ">
                        <p>NAME OF DECEASED / मृताचे नाव: <span><?php echo $name ?></span> / <span class="hinditext textNormal"><?php echo  $name_m; ?></span></p>

                        <p class="marginp">AADHAAR NO. / आधार क्रमांक:</p>
                        <p><span class="hideAadhar"><?php echo $aadharNo;  ?></span></p>

                        <p class="marginp">DATE OF DEATH / मृत्यू दिनांक:</p>
                        <p class="marginp"><span><?php echo $dateOfDeath;  ?></span></p>
                        <p><span><?php echo $dateOfDeath_m;  ?></span></p>

                        <p class="marginp">AGE OF DECEASED / मृत व्यक्तीचे वय:</p>
                        ...
                        <p>MOTHER'S AADHAAR NO. / आधार क्रमांक: <span class="hideAadhar"><?php echo $motherAadhaar;  ?></span></p>

                        <p class="marginp">ADDRESS OF DECEASED AT THE TIME OF DEATH / मयत व्यक्तीचा मृत्युसमयीचा पत्ता:</p>
                    ...
                    <div class="tdata3 col-5">
                        ...
                        <p class="marginp">PLACE OF DEATH / मृत्यूचे ठिकाण: </p>
                        <p><span><?php echo $placeOfDeath ?></span> / <span class="hinditext textNormal"><?php echo  $placeOfDeath_m; ?></span> </p>

                        <p class="marginp">NAME OF HUSBAND/WIFE / पती/पत्नी माहिती नाव: </p>
                        <p><span><?php echo $nameOfHusband_Wife ?></span> / <span class="hinditext textNormal"><?php echo  $nameOfHusband_Wife_m; ?></span></p>

                        <p>HUSBAND/WIFE AADHAAR NO. / आधार क्रमांक: <span class="hideAadhar"><?php echo $aadhaarOfHusband_Wife; ?></span></p>
                        ...
                        <p>FATHER'S AADHAAR NO. / आधार क्रमांक: <span class="hideAadhar"><?php echo $fatherAadhaar; ?></span></p>

                        <p class="marginp">PERMANENT ADDRESS OF DECEASED / मयत व्यक्तीचा कायमचा पत्ता: </p>
