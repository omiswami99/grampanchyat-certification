...
if (isset($_GET['id'])) {
    ...
    if ($id != "") {
        ...
        $text = "http://shambhaviagro.in/grampanchyatpalasdeo/print/birth.php?id=$id";
        $path = '../qrImage/';
    ...
    <div class="container" style="height: 1500px;border: 2px solid black">
        ...
        <div class="tblock row" style="margin-top: 30px;">
            <div class="tdata1 col-7 ">
                <p> NAME / नाव : <span><?php echo $name ?></span>/<span class="hinditext textNormal"><?php echo $name_m ?></span></p>

                <p class="marginp">DATE OF BIRTH / जन्म तारीख :</p>
                <p><span><?php echo $DOB;  ?></span></p>

                <p class="marginp">NAME OF MOTHER / आईचे पूर्ण नाव :</p>
                <p class="marginp"><span><?php echo $nameOfMother;  ?></span>/
                <span class="hinditext textNormal"><?php echo $nameOfMother_m;  ?></span></p>

                <p class="marginp">MOTHER'S AADHAAR NO / आधार क्रमांक :</p>
                <p><span class="hideAadhar"><?php echo $motherAadharNo;  ?></span></p>

                <p class="marginp">ADDRESS OF PARENTS AT THE TIME OF BIRTH OF THE CHILD / बाळाच्या जन्माच्यावेळी आई वडिलांचा पत्ता : </p>
                <p><?php
                if ($addressDuringBirth_m == 'पळसदेव' || $addressDuringBirth_m == 'बांडेवाडी' || $addressDuringBirth_m == 'काळेवाडी' || $addressDuringBirth_m == 'माळेवाडी') { ?>
                    <span class="hinditext textNormal" style="font-size: 00.9rem;"><?php echo $addressDuringBirth_m;  ?></span>
                <?php } else { ?>
                    <span class="hinditext textNormal"><?php echo $addressDuringBirth_m;  ?></span>
                <?php }
                ?>/<span><?php echo $addressDuringBirth ?></span></p>

                <p class="marginp">REGISTRATION NO / नोंदणी क्रमांक :</p>
                <p><span><?php echo $id;  ?></span></p>

                <p class="marginp">REMARKS (IF ANY) / शेरा :</p>
                <p><span> <?php echo $remark; ?></span></p>
            </div>
            <div class="tdata3 col-5">
                <p>SEX / लिंग : <span><?php echo $sex . "</span>/<span style='font-size: 0.9rem;'>" . $sex_m; ?></span></p>

                <p class="marginp">PLACE OF BIRTH / जन्म ठिकाण : </p>
                <p><span><?php echo $placeOfBirth ?></span>/<span class="hinditext textNormal"><?php echo $placeOfBirth_m; ?></span> </p>

                <p class="marginp">NAME OF FATHER / वडिलांचे पूर्ण नाव :</p>
                <p><span><?php echo $nameOfFather ?></span>/<span class="hinditext textNormal"><?php echo $nameOfFather_m; ?></span></p>

                <p>FATHER'S AADHAAR NO. / आधार क्रमांक : <span class="hideAadhar"><?php echo $fatherAadharNo; ?></span></p>

                <p class="marginp">PERMANENT ADDRESS OF PARENTS / आई-वडिलांचा कायमचा पत्ता : </p>
                ...
                <p class="marginp">DATE OF REGISTRATION /  नोंदणी दिनांक :</p>
        ...
        <div class="forblock row" style="margin-top: 15px;">
            <div class="fordata1 col-7">
                <p class="marginp">DATE OF ISSUE / प्रमाणपत्र दिल्याची दिनांक :</p>
